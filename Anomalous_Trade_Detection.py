...
# Function to get files from source bucket
 ...
 if FileExists == True:
    ...
    # Add the Total market value to the main df
    ...
    # Send email 
    send_email(washtrades)

    # Move files to processed bucket
    moveFiles(mfilelist)
 else:
...
def moveFiles(mfilelist):
 ...
 for file in mfilelist:
    ...
    get_object_response = object_storage_client.get_object(
        namespace_name=vnamespace,
        bucket_name=vbucket_name,
        object_name=file) #Trade_Files_For_Processing/part-00000-9485af3e-36ba-41da-bcb5-5f2a6dc67286-c000.csv
    ...
    obj = object_storage_client.put_object(
                vnamespace,
                vbucket_name,
                file.replace(Files_For_Processing_Path,Files_After_Processing_Path), #Trade_Files_After_Processing/part-00000-9485af3e-36ba-41da-bcb5-5f2a6dc67286-c000.csv
